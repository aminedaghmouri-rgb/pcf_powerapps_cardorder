...
export class UserManagerPcf8 implements ComponentFramework.StandardControl<IInputs, IOutputs> {
    ...
    public getOutputs(): IOutputs {
        return {
            ...
            selectedIds: this.outputSelectedIds || undefined,
            formData: this.outputFormData || undefined,
            eventToken: this.outputEventToken || undefined,
            saveSignal: this.outputSaveSignal || undefined,
            searchTerm: this.outputSearchTerm || undefined,
            selectedId: this.outputSelectedId || undefined, // New output
        };
    }
    ...
    private getValueBadgeColor(value: string): { bg: string; fg: string } {
        ...
        const palette = UserManagerPcf8.BADGE_PALETTE;
